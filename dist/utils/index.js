...
const buildDialogContext = ({ 
// General
patientName, dateOfBirth, gender, occupation, 
// Main
presentingComplaint, medicalHistory, lifeStyle, 
// Personal
emotionalState, personalTraits, communicationStyle, 
// Additional
clinicalContext, objectiveForStudent, }) => {
    return `
